...
| V2-02 Initial validation corpus | In progress; externally gated | Eight checked-in review cases cover atmosphere, descent, drift, static load screening, and scalar/curve representative end-to-end plans | Add explicit ascent-domain, unit-conversion, edge-case, metamorphic coverage and independent review before any case becomes accepted |
