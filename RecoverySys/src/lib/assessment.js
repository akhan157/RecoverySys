...
export function buildAssessment({
  ...
  if (!isEvaluated && normalizedReasonCodes.length === 0) normalizedReasonCodes.push('NOT_EVALUATED')
...
export function buildResultAssessments(result, { fresh = true, envelope, evidenceState, evidenceIds } = {}) {
