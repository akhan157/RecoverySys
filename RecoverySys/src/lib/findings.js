...
export function compatibilityFindingCode(slot, rule = 'unclassified') {
  ...
  if (lower.startsWith('kevlar cord with nylon chute')) return family('chute-cord-material-mismatch')
  if (lower.includes("won't fit") && lower.startsWith('quick link')) return family('quick-link-opening-small')
